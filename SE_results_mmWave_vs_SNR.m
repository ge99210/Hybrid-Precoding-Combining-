...
SE_Full_Dig_5 = SE_Full_Dig;
SE_Hybrid_omp_total_5 = SE_Hybrid_omp_total;
SE_Hybrid_md_total_5 = SE_Hybrid_md_total;
SE_Hybrid_sags_total_5 = SE_Hybrid_sags_total;

f1 = figure(1);
subplot(2,1,1);
plot(SNR_set,SE_Full_Dig_5,'ko-', 'Linewidth', 1.5,'MarkerSize',4);
hold on;
plot(SNR_set,SE_Hybrid_omp_total_5,'gv--', 'Linewidth', 1.5,'MarkerSize',4);
plot(SNR_set,SE_Hybrid_md_total_5,'r^:', 'Linewidth', 1.5,'MarkerSize',4);
plot(SNR_set,SE_Hybrid_sags_total_5,'bo-.', 'Linewidth', 1.5,'MarkerSize',4);
