...
% Rayleigh channels perfect channel-state-information (PCSI) vs SNR
...
disp(['The maximum SE gain of MDP over HPSAGS is ', num2str(max(SE_Hybrid_md_total-SE_Hybrid_sags_total)), ' bits/s/Hz']);
...
hl = legend('Optimal U-SVD','MDP','HPSAGS','Location','Northwest');
