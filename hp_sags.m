function  [F_R, F_B, conv_cond, k_t]  = hp_sags(F_opt, mu_v, eta, Theta, Tmax, EPS)
% Hybrid Precoding with Stochastic Approximation with Gaussian Smoothing (HPSAGS)
...
% This is the analytical expressiong of the gradient 
% for the cost function in hybrid precoding
          M = V_opt - g(X)*F_B;
